// @ts-ignore
import { Upload, Package, FileText, Database } from 'lucide-react'
                    ...
                    {attachments.map((file, idx) => (
                        <div key={idx} className="flex items-center justify-between p-3 rounded-xl bg-white/5 border border-[var(--border)] group hover:border-[var(--prime)]/30 transition-all">
                            ...
                            <button
                                ...
                                className="p-1.5 rounded-lg text-[var(--text-muted)] hover:text-red-500 hover:bg-red-500/10 transition-all active:scale-90"
                            >
                                <TrashIcon />
                            </button>
                        </div>
